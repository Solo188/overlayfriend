...
void MMDRenderer::render(float dt) {
    ...
    glm::mat4 view = glm::lookAt(glm::vec3(0.0f, 11.5f, 50.0f),
...
void MMDRenderer::drawModel() {
    ...
    for (size_t li = 0; li < loopCount; ++li) {
        ...
        // =====================================================================
        // === ФИКС КАШИ НА ЛИЦЕ (ГЛАЗА И РОТ) ================================
        // =====================================================================
        //   Проблема: маленькие полигоны лица (глаза, рот, брови) рисуются
        //   в том же месте Z-буфера, что и кожа — возникает Z-fighting (мерцание).
        //
        //   Решение: для мелких субмешей (< 2000 вершин) в прозрачном пассе
        //   мы принудительно "выталкиваем" их чуть ближе к камере через
        //   Polygon Offset, чтобы они перекрыли кожу без мерцания.
        //
        //   КАК ПОДКРУТИТЬ:
        //     glPolygonOffset(-1.0f, -1.0f) — текущее смещение.
        //     Если глаза/рот всё равно мерцают или проваливаются в кожу
        //     → изменить -1.0f на -2.0f или даже -3.0f:
        //       glPolygonOffset(-2.0f, -2.0f);
        //
        //     Если смещение слишком большое и детали "плавают" перед лицом
        //     → вернуть к -1.0f или попробовать -0.5f.
        //
        //   Порог 2000 вершин: субмеши с меньшим числом вершин считаются
        //   мелкими деталями лица. Если крупный элемент тоже мерцает →
        //   увеличить порог до 5000.
        // =====================================================================
